				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						...
						<div class="carousel-caption d-none d-md-block">
							<a href="crearSolicitud" class="btn btn-warning">Intercambia ahora!</a>
						</div>
					</div>
					<div class="carousel-item">
						<img src="https://www.markuptag.com/images/slider-img-2.jpg"
							class="d-block w-100" alt="...">
						<div class="carousel-caption d-none d-md-block">
							<a href="crearSolicitud" class="btn btn-warning">Cuida tu hogar!</a>
						</div>
					</div>
					<div class="carousel-item">
						<img src="https://www.markuptag.com/images/slider-img-3.jpg"
							class="d-block w-100" alt="...">
						<div class="carousel-caption d-none d-md-block">
							<a href="crearSolicitud" class="btn btn-warning">Haz tu donacion!</a>
						</div>
					</div>
				</div>
